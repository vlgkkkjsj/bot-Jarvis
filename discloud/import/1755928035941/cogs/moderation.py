...
class ConfirmActionView(discord.ui.View):
    ...
    async def confirm_button(self, interaction: discord.Interaction, btn: discord.ui.Button):
        # Desabilita botões
        ...
        try:
            ...
            await interaction.response.edit_message(content=f"❌ Ocorreu um erro: {e}", embed=None, view=self)
        finally:
            self.stop()

    @discord.ui.button(label="❌ Cancelar", style=discord.ButtonStyle.secondary)
    async def cancel_button(self, interaction: discord.Interaction, btn: discord.ui.Button):
        for child in self.children:
            child.disabled = True
